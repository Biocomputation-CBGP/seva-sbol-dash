...
# ---------------------- Pick a layout ----------------------
    ...
    def set_type_node_color(self):
        if self.node_color == self.set_type_node_color:
            return self._color_h.node.type()
        else:
            self.node_color = self.set_type_node_color

    def set_role_node_color(self):
        if self.node_color == self.set_role_node_color:
            return self._color_h.node.role()
        else:
            self.node_color = self.set_role_node_color
    # ---------------------- Edge Color ----------------------
    ...
    def add_type_edge_color(self):
        ...
        if self.edge_color == self.add_type_edge_color:
            return self._color_h.edge.type()
        else:
    ...
    def _build_edge(self, edge, label, c_key, color, edge_shape):
        edge = {'data': {'source': edge[0], 'target': edge[1], 'label': label},
